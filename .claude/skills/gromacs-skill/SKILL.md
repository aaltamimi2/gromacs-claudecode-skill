...
- **[references/mpi-configuration.md](references/mpi-configuration.md)**: MPI setup, gmx vs gmx_mpi, fixing MPI errors
...
| MPI write_line error | Running gmx_mpi without mpirun | Use `mpirun -np 1 gmx_mpi` |
